  ...
  if ((move.flags['dance'] || move.type === 'Fairy') && moveDidSomething && !move.isExternal) {
			...
			sensudancers.sort(function (a, b) { return -(b.stats['spe'] - a.stats['spe']) || b.abilityOrder - a.abilityOrder; });
  ...
  if ((move.flags['dance'] || move.type === 'Grass') && moveDidSomething && !move.isExternal) {
			...
			// Dancer activates in order of lowest speed stat to highest
			// Ties go to whichever Pokemon has had the ability for the least amount of time
			bailedancers.sort(function (a, b) { return -(b.stats['spe'] - a.stats['spe']) || b.abilityOrder - a.abilityOrder; });
  ...
  if ((move.flags['dance'] || move.type === 'Psychic') && moveDidSomething && !move.isExternal) {
			...
			// Dancer activates in order of lowest speed stat to highest
			// Ties go to whichever Pokemon has had the ability for the least amount of time
			paudancers.sort(function (a, b) { return -(b.stats['spe'] - a.stats['spe']) || b.abilityOrder - a.abilityOrder; });
  ...
  if ((move.flags['dance'] || move.type === 'Electric') && moveDidSomething && !move.isExternal) {
			...
			// Dancer activates in order of lowest speed stat to highest
			// Ties go to whichever Pokemon has had the ability for the least amount of time
			pompomdancers.sort(function (a, b) { return -(b.stats['spe'] - a.stats['spe']) || b.abilityOrder - a.abilityOrder; });
