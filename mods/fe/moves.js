...
// Foul Mimicry
	...
	"radioactiveterrain": {
		...
		effect: {
			...
			onBasePower: function (basePower, attacker, defender, move) {
				if ((move.type === 'Electric' || move.type === 'Poison') && attacker.isGrounded()) {
